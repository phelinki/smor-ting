...
void main() {
  group('Navigation Flow Service', () {
    ...
    group('getPostOTPVerificationDestination', () {
      test('should navigate customer to home after OTP verification', () {
        // Arrange
        final user = User(
          id: '1',
          email: 'customer@test.com',
        ...
        // Act
        final result = navigationFlowService.getPostOTPVerificationDestination(user);
      ...
      test('should navigate provider to KYC if not verified', () {
        // Arrange
        final user = User(
          id: '2',
          email: 'provider@test.com',
        ...
        // Act
        final result = navigationFlowService.getPostOTPVerificationDestination(
          user,
          requiresKyc: true,
        );
      ...
      test('should navigate provider to dashboard if KYC already complete', () {
        // Arrange
        final user = User(
          id: '2',
          email: 'verifiedprovider@test.com',
          firstName: 'Verified',
          lastName: 'Provider',
          phone: '+1234567890',
          role: UserRole.provider,
      ...
      test('should navigate admin to admin dashboard after OTP verification', () {
        // Arrange
        final user = User(
          id: '3',
          email: 'admin@test.com',
